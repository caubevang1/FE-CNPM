...
export default () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (value) => {
            let { username, hoTen, email, password, phoneNumber } = value
        ...
        <div className='addFilmAdmin'>
            ...
            >
                <Form.Item label="Tài khoản">
                    <Input autoComplete='off' name='username' onChange={formik.handleChange} />
                </Form.Item>
                ...
                <Form.Item label="Mật khẩu">
                    <Input autoComplete='off' name='password' onChange={formik.handleChange} />
                </Form.Item>
                <Form.Item label="Số điện thoại">
                    <Input autoComplete='off' name='phoneNumber' onChange={formik.handleChange} />
                </Form.Item>
