            ...
            <div className='block mt-16 sm:mt-8 md:mt-0 md:hidden'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4'>
                    {arrFilm.filter(item => {
                        ...
                        <img src={itemFilm.moviePoster} alt={itemFilm.moviePoster} onError={(e) => { e.target.onerror = null; e.target.src = 'https://picsum.photos/75/75' }} className="object-cover object-center w-full rounded-t-md h-44 sm:h-52 " />
                        <div className="flex flex-col justify-between p-4 ">
                            <h2 className="film-name-card-mobile font-semibold mb-2">{itemFilm.movieName.length > 22 ? itemFilm.movieName.toUpperCase().slice(0, 22) + '...' : itemFilm.movieName.toUpperCase()}</h2>
